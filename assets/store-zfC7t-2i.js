...
}`},wt=[Ve,Ye,Je,Ke,We,Qe,Ze,et,tt,st,ot,rt,at,nt,lt,ut,ht,ft,dt,pt,mt,bt,vt,it,ct,gt],ye=new Map(wt.map(e=>[e.id,e]));function te(e){return ye.get(e)}function Ee(e){return ye.has(e)}function io(e){const t={};for(const o of e.params)t[o.key]=o.def;return t}const co=[{id:"move",label:"move"},{id:"mirror",label:"mirror"},{id:"colour",label:"colour"},{id:"light",label:"light"},{id:"grit",label:"grit"},{id:"time",label:"time"}],le=(e,t=0,o=1)=>e<t?t:e>o?o:e,Te={abs:e=>Math.abs(e[0]??0),sign:e=>Math.sign(e[0]??0),sqrt:e=>Math.sqrt(Math.max(0,e[0]??0)),floor:e=>Math.floor(e[0]??0),ceil:e=>Math.ceil(e[0]??0),round:e=>Math.round(e[0]??0),fract:e=>(e[0]??0)-Math.floor(e[0]??0),sin:e=>Math.sin(e[0]??0),cos:e=>Math.cos(e[0]??0),tan:e=>Math.tan(e[0]??0),exp:e=>Math.exp(e[0]??0),log:e=>Math.log(Math.max(1e-9,e[0]??0)),pow:e=>Math.pow(e[0]??0,e[1]??1),min:e=>e.length===0?0:Math.min(...e),max:e=>e.length===0?0:Math.max(...e),mod:e=>{const t=e[1]??1;return t===0?0:(e[0]??0)-Math.floor((e[0]??0)/t)*t},clamp:e=>le(e[0]??0,e[1]??0,e[2]??1),mix:e=>(e[0]??0)+((e[1]??0)-(e[0]??0))*(e[2]??0),lerp:e=>(e[0]??0)+((e[1]??0)-(e[0]??0))*(e[2]??0),step:e=>(e[1]??0)<(e[0]??0)?0:1,smoothstep:e=>{const t=e[0]??0,o=e[1]??1;if(o===t)return(e[2]??0)<t?0:1;const s=le(((e[2]??0)-t)/(o-t));return s*s*(3-2*s)},hash:e=>{const t=Math.sin((e[0]??0)*127.1)*43758.5453;return t-Math.floor(t)}},$e=new Set(["smooth","glide"]),xt=(e,t,o,s)=>o<=0?t:t+(e-t)*Math.pow(.001,s/o),Ae={pi:Math.PI,tau:Math.PI*2,e:Math.E,true:1,false:0},lo=[...Object.keys(Te),...$e].sort(),uo=Object.keys(Ae).sort(),_t=["<=",">=","==","!=","&&","||","+","-","*","/","%","^","(",")",",","?",":","<",">","!"];function yt(e){const t=[];let o=0;for(;o<e.length;){const s=e[o]??"";if(s===" "||s==="	"||s===`
`||s==="\r"){o+=1;continue}if(s>="0"&&s<="9"||s==="."&&/[0-9]/.test(e[o+1]??"")){const n=/^[0-9]*\.?[0-9]+(?:e[-+]?[0-9]+)?/i.exec(e.slice(o));if(n===null)return`that number at ${o+1} does not parse`;t.push({kind:"num",value:Number(n[0]),at:o}),o+=n[0].length;continue}if(/[a-z_]/i.test(s)){const n=/^[a-z_][a-z0-9_]*(?:\.[a-z0-9_]+)*/i.exec(e.slice(o));if(n===null)return`that name at ${o+1} does not parse`;t.push({kind:"name",value:n[0],at:o}),o+=n[0].length;continue}const r=_t.find(n=>e.startsWith(n,o));if(r===void 0)return`“${s}” is not something this understands`;t.push({kind:"op",value:r,at:o}),o+=r.length}return t.push({kind:"end",at:e.length}),t}const Et={"||":1,"&&":2,"==":3,"!=":3,"<":3,">":3,"<=":3,">=":3,"+":4,"-":4,"*":5,"/":5,"%":5,"^":6},Tt={"+":(e,t)=>e+t,"-":(e,t)=>e-t,"*":(e,t)=>e*t,"/":(e,t)=>e/t,"%":(e,t)=>t===0?0:e-Math.floor(e/t)*t,"^":(e,t)=>Math.pow(e,t),"<":(e,t)=>e<t?1:0,">":(e,t)=>e>t?1:0,"<=":(e,t)=>e<=t?1:0,">=":(e,t)=>e>=t?1:0,"==":(e,t)=>e===t?1:0,"!=":(e,t)=>e!==t?1:0,"&&":(e,t)=>e!==0&&t!==0?1:0,"||":(e,t)=>e!==0||t!==0?1:0};class L extends Error{}function $t(e,t,o){let s=0;const r=()=>e[s]??{kind:"end",at:0},n=()=>e[s++]??{kind:"end",at:0},l=d=>{const a=r();if(a.kind!=="op"||a.value!==d)throw new L(`expected “${d}”`);s+=1},h=()=>{const d=n();if(d.kind==="num"){const a=d.value;return()=>a}if(d.kind==="op"&&d.value==="("){const a=b(0);return l(")"),a}if(d.kind==="op"&&d.value==="-"){const a=h();return(c,p)=>-a(c,p)}if(d.kind==="op"&&d.value==="!"){const a=h();return(c,p)=>a(c,p)===0?1:0}if(d.kind==="name"){const a=d.value,c=r();if(c.kind==="op"&&c.value==="("){const v=Te[a],u=$e.has(a);if(v===void 0&&!u)throw new L(`there is no function called “${a}”`);s+=1;const m=[];if(!(r().kind==="op"&&r().value===")"))for(;;){m.push(b(0));const x=r();if(x.kind==="op"&&x.value===","){s+=1;continue}break}if(l(")"),u){const x=o.n++,E=a==="smooth";return(w,T)=>{const A=m[0]?.(w,T)??0,O=m[1]?.(w,T)??.2,F=T.mem[x]??A,ne=E&&A>=F?A:xt(F,A,O,T.dt);return T.mem[x]=ne,ne}}const f=v;return(x,E)=>f(m.map(w=>w(x,E)))}const p=Ae[a];return p!==void 0?()=>p:(t.add(a),v=>v(a))}throw new L(d.kind==="end"?"it stops in the middle":"that is not something this understands")},b=d=>{let a=h();for(;;){const c=r();if(c.kind!=="op")break;if(c.value==="?"&&d===0){s+=1;const f=b(0);l(":");const x=b(0),E=a;a=(w,T)=>E(w,T)!==0?f(w,T):x(w,T);continue}const p=Et[c.value];if(p===void 0||p<d)break;s+=1;const v=Tt[c.value];if(v===void 0)throw new L(`“${c.value}” cannot be used like that`);const u=b(c.value==="^"?p:p+1),m=a;a=(f,x)=>v(m(f,x),u(f,x))}return a},g=b(0);if(r().kind!=="end")throw new L("there is something left over at the end");return g}const ue=new Map,J=e=>({run:()=>Number.NaN,slots:0,error:e,names:[]});function oe(e){const t=ue.get(e);if(t!==void 0)return t;const o=At(e);return ue.set(e,o),o}function At(e){if(e.trim()==="")return J("empty");const t=yt(e);if(typeof t=="string")return J(t);const o=new Set,s={n:0};try{return{run:$t(t,o,s),slots:s.n,error:null,names:[...o].sort()}}catch(r){return J(r instanceof L?r.message:String(r))}}const St={dt:1/60,mem:new Float64Array(0)};function Rt(e,t,o,s=St){const r=oe(e);if(r.error!==null)return o;const n=r.run(t,s);return Number.isFinite(n)?n:o}function R(e){return typeof e=="object"&&e!==null&&"source"in e}function M(e){return typeof e=="object"&&e!==null&&"expr"in e}function ho(e,t){return e===void 0?t:R(e)?e.base:M(e)?t:e}function y(e,t,o){return{source:t,base:e,depth:o,curve:1,fall:.12}}function re(e){return{id:`lfo-${e}`,name:e,shape:"sine",sync:!0,bars:4,hz:.25,phase:0,duty:.5}}const Se=.25,Re=.18,ae=.08;let he=0;function fe(e={}){return he+=1,{id:`r${he.toString(36)}`,shape:"rect",x:.5,y:.5,w:.3,h:.18,rot:0,feather:.35,amount:1,drift:ae,...e}}const fo={id:"untitled",name:"untitled",scene:"greenhouse",mount:"plate",blend:"normal",opacity:1,lfos:[re("a")],layers:[],notes:""};function po(e,t){return e.wears===void 0||e.wears.length===0||t===void 0?!0:e.wears.includes(t)}let pe=0;function mo(e){return pe+=1,`${e}-${pe.toString(36)}`}function de(e){const t=new Set,o=s=>{if(R(s)&&t.add(s.source),M(s))for(const r of oe(s.expr).names)t.add(r)};for(const s of e.layers){o(s.mix);for(const r of Object.values(s.params))o(r);for(const r of s.regions??[])o(r.amount)}for(const s of e.dress??[])for(const r of Object.values(s.moves))o(r);return[...t].sort()}function ke(e,t){return{...e,layers:e.layers.filter(o=>t(o.effect))}}const k=(e,t,o)=>({...re(e),shape:t,bars:o}),kt=[{id:"rgb-wobble",name:"RGB wobble",scene:"greenhouse",mount:"plate",blend:"normal",opacity:1,notes:"The house preset. The channels part on the low end and drift on a slow LFO.",lfos:[k("slow","sine",8)],layers:[{id:"w1",effect:"wobble",on:!0,mix:1,params:{amount:{...y(9e-4,"music.low",.0045),curve:1.6,fall:.2},angle:y(0,"lfo.slow",1),spin:0,sep:1}},{id:"w2",effect:"sway",on:!0,mix:1,params:{x:.004,y:.002,rate:.097,lag:.25}}]},{id:"glasshouse-breath",name:"glasshouse breath",scene:"greenhouse",mount:"plate",blend:"normal",opacity:1,notes:"The room has a pulse. Zoom on the downbeat, noise drift under it, lamp spills.",lfos:[k("drift","noise",6)],layers:[{id:"b1",effect:"breathe",on:!0,mix:1,params:{amount:{...y(0,"bar.pulse",.011),curve:2,fall:.3},cx:.42,cy:.52,roll:0}},{id:"b2",effect:"flow",on:!0,mix:1,params:{amount:{...y(.002,"music.mid",.004),curve:1.4,fall:.35},scale:2.1,speed:.174,warp:.4}},{id:"b3",effect:"bloom",on:!0,mix:1,params:{amount:{...y(.14,"music.level",.22),curve:1.5,fall:.4},threshold:.66,radius:7}}]},{id:"hat-paper",name:"hi-hat paper",scene:"greenhouse",mount:"over",blend:"soft-light",opacity:.9,notes:"Over-mount. The paper grain moves with the hats; the corners close as pressure rises.",lfos:[],layers:[{id:"g1",effect:"grain",on:!0,mix:1,params:{amount:{...y(.02,"music.high",.07),curve:1.8,fall:.09},size:1.6,speed:24,colour:.15}},{id:"g2",effect:"vignette",on:!0,mix:1,params:{amount:{...y(.1,"pressure",.45),curve:1,fall:1.2},radius:.8,soft:.5}}]},{id:"rose-window",name:"rose window",scene:"greenhouse",mount:"plate",blend:"normal",opacity:.55,notes:"Mirrors, folded on a slow turn. Half opacity because at full it is a screensaver.",lfos:[k("turn","saw",32),k("split","sine",12)],layers:[{id:"k1",effect:"kaleido",on:!0,mix:.5,params:{slices:6,spin:.0077,zoom:y(1.1,"lfo.split",.25),cx:.5,cy:.45}},{id:"k2",effect:"mirror",on:!0,mix:{...y(.15,"music.level",.4),curve:1.6,fall:.5},params:{axis:0,split:y(.42,"lfo.split",.16),flip:0,mix2:1}}]},{id:"signal-rot",name:"signal rot",scene:"inside",mount:"plate",blend:"normal",opacity:1,notes:"For the bad end of a fight. Bands jump on a hit, the frame holds and cools.",lfos:[k("gate","hold",2)],layers:[{id:"s1",effect:"slice",on:!0,mix:{...y(0,"sfx.hit",1),curve:2.2,fall:.22},params:{amount:.035,rows:34,speed:4,chance:.3}},{id:"s2",effect:"trails",on:!0,mix:1,params:{feedback:{...y(.42,"music.low",.3),curve:1.4,fall:.5},zoom:.003,spin:.001,driftx:0,drifty:0,fade:.09}},{id:"s3",effect:"poster",on:!0,mix:.5,params:{steps:14,dither:.5}}]},{id:"dusk-light",name:"dusk light",scene:"greenhouse",mount:"over",blend:"screen",opacity:.75,notes:"All light, no picture. Beams through the glass, dust rising, fog on the floor.",lfos:[k("breeze","noise",10)],layers:[{id:"l1",effect:"beams",on:!0,mix:1,params:{amount:{...y(.07,"music.level",.1),curve:1.6,fall:.6},angle:.14,count:4.5,spread:.45,drift:.0155,hue:.1}},{id:"l2",effect:"motes",on:!0,mix:1,params:{amount:.22,count:22,size:1.5,rise:.039,hue:.11}},{id:"l3",effect:"fog",on:!0,mix:1,params:{amount:y(.08,"lfo.breeze",.07),scale:1.4,speed:.058,hue:.55,sat:.12,height:.55}}]}],Mt={id:"river-road",name:"the road, upstream",scene:"greenhouse",mount:"plate",blend:"normal",opacity:1,notes:"The band of soil only. Mirrors along it with the reflections flowing upstream, breathing on a four-bar LFO. Sky and glasshouse untouched.",lfos:[{...re("breath"),shape:"sine",bars:4}],layers:[{id:"rr1",effect:"river",on:!0,mix:.42,regions:[{...fe(),shape:"rect",x:.5,y:.53,w:.52,h:.135,rot:0,feather:.75,amount:1}],params:{angle:0,period:.17,flow:.0426,ratio:2.31,tangle:.3,reach:1.1,breathe:0,rate:.087,cx:.5,cy:.53}},{id:"rr2",effect:"breathe",on:!0,mix:1,regions:[{...fe(),x:.5,y:.53,w:.52,h:.16,feather:.85,amount:.7}],params:{amount:y(.002,"lfo.breath",.006),cx:.5,cy:.53,roll:0}}]},Ft={id:"the-room-breathes",name:"the room breathes",scene:"greenhouse",mount:"plate",blend:"normal",opacity:1,notes:"The interface on the transport. Hand lifts on the downbeat, puppets breathe over four bars, the button glows on the bass. Nothing in seconds — it survives a tempo change.",lfos:[k("breath","sine",4)],layers:[{id:"db1",effect:"breathe",on:!0,mix:1,params:{amount:{...y(0,"bar.pulse",.006),curve:2,fall:.35},cx:.5,cy:.5,roll:0}}],dress:[{id:"dh",target:"hand",on:!0,moves:{y:{...y(0,"bar.pulse",-2.2),curve:2,fall:.28}}},{id:"dp",target:"puppets",on:!0,moves:{scale:y(.997,"lfo.breath",.006),y:y(0,"lfo.breath",-1.4)}},{id:"de",target:"ender",on:!0,moves:{glow:{...y(0,"music.low",7),curve:1.8,fall:.3}}},{id:"dt",target:"ticker",on:!0,moves:{sat:{...y(1,"music.high",.35),curve:1.6,fall:.4}}}]},bo=[...kt,Mt,Ft],Q=`#version 300 es
in vec2 a_pos;
...
`,cs=[{id:"lfo-drift",name:"drift",shape:"noise",sync:!0,bars:32,hz:.25,phase:.07,duty:.5},{id:"lfo-a",name:"a",shape:"sine",sync:!0,bars:6,hz:.25,phase:0,duty:.5},{id:"lfo-b",name:"b",shape:"sine",sync:!0,bars:12,hz:.25,phase:0,duty:.5},{id:"lfo-c",name:"c",shape:"sine",sync:!0,bars:16,hz:.25,phase:0,duty:.5}],ls=[{id:"flow-2",effect:"flow",on:!0,mix:1,params:{amount:.032,scale:1.66,speed:.542,warp:.199}},{id:"wobble-3",effect:"wobble",on:!0,mix:{expr:"0.25 + smooth(music.low, 0.35) * 0.5"},params:{amount:.009,angle:{expr:"lfo.a"},spin:{expr:".1"},sep:1}},{id:"bloom-5",effect:"bloom",on:!0,mix:.289,params:{amount:.723,threshold:{expr:".5+lfo.c/5"},radius:{expr:"lfo.b*20"}}}],us=["intro"],hs={id:ts,name:ss,scene:os,mount:rs,blend:as,opacity:ns,notes:is,lfos:cs,layers:ls,wears:us},fs="dusk-light",ps="dusk light",ds="greenhouse",ms="over",bs="screen",vs=.75,gs="All light, no picture. Beams through the glass, dust rising, fog on the floor.",ws=[{id:"lfo-breeze",name:"breeze",shape:"noise",sync:!0,bars:10,hz:.25,phase:0,duty:.5}],xs=[{id:"l1",effect:"beams",on:!0,mix:1,params:{amount:{source:"music.level",base:.07,depth:.1,curve:1.6,fall:.6},angle:.14,count:4.5,spread:.45,drift:.008,hue:.1}},{id:"l2",effect:"motes",on:!0,mix:1,params:{amount:.22,count:22,size:1.5,rise:.02,hue:.11}},{id:"l3",effect:"fog",on:!0,mix:1,params:{amount:{source:"lfo.breeze",base:.08,depth:.07,curve:1,fall:.12},scale:1.4,speed:.03,hue:.55,sat:.12,height:.55}}],_s={id:fs,name:ps,scene:ds,mount:ms,blend:bs,opacity:vs,notes:gs,lfos:ws,layers:xs},ys="gentle-trip",Es="gentle trip",Ts="greenhouse",$s="plate",As="normal",Ss=1,Rs=`A gentle trip for the background. The ripple's depth and ring count each swing 20% about where they were set, on two 16-bar sine LFOs half a cycle apart — so the rings crowd in as the depth eases off, and open out as it swells. Nothing lands on a beat; it is meant to be noticed on the second play.
...
`,ks=[{id:"lfo-slow",name:"slow",shape:"sine",sync:!0,bars:32,hz:.25,phase:.2,duty:.5},{id:"lfo-trip",name:"trip",shape:"sine",sync:!0,bars:16,hz:.25,phase:0,duty:.5},{id:"lfo-counter",name:"counter",shape:"sine",sync:!0,bars:16,hz:.25,phase:.5,duty:.5}],Ms=[{id:"w1",effect:"wobble",on:!0,mix:1,params:{amount:{source:"music.low",base:9e-4,depth:.0045,curve:1.6,fall:.2},angle:{source:"lfo.slow",base:0,depth:1,curve:1,fall:.12},spin:0,sep:1}},{id:"w2",effect:"sway",on:!0,mix:1,params:{x:.016,y:.015,rate:.22065,lag:.39}},{id:"breathe-1",effect:"breathe",on:!0,mix:1,params:{amount:.066,cx:.5,cy:.5,roll:0}},{id:"ripple-2",effect:"ripple",on:!0,mix:1,params:{amount:{source:"lfo.trip",base:.0112,depth:.0056,curve:1,fall:0},freq:{source:"lfo.counter",base:25.84,depth:12.92,curve:1,fall:0},speed:.2071,cx:.034,cy:.047}}],Fs={id:ys,name:Es,scene:Ts,mount:$s,blend:As,opacity:Ss,notes:Rs,lfos:ks,layers:Ms},Ls="infiltrated",Is="infiltrated",Us="inside",Ps="plate",Bs="normal",Os=1,Ns="infiltration background always during combats when theres been an infultration move to this",zs=[{id:"lfo-slow",name:"slow",shape:"sine",sync:!0,bars:8,hz:.25,phase:.2,duty:.5},{id:"lfo-a",name:"a",shape:"sine",sync:!0,bars:4,hz:.25,phase:0,duty:.5}],Ds=[{id:"beams-1",effect:"beams",on:!0,mix:1,params:{amount:.262,angle:.352,count:1.3,spread:.541,drift:.143,hue:.567}},{id:"bleed-4",effect:"bleed",on:!0,mix:.186,params:{amount:.093,cx:.675,cy:.5,bias:{expr:"music.low"}},regions:[{id:"r3",shape:"rect",x:.11363412771804315,y:.8923691012244847,w:.9261963848769764,h:.18559530559923842,rot:-.008,feather:0,amount:1,drift:.3}]},{id:"grain-2",effect:"grain",on:!0,mix:.684,params:{amount:.08,size:1.1,speed:9,colour:.043},regions:[{id:"r4",shape:"rect",x:.8238036927100948,y:.17707226267922282,w:.17873868043426822,h:.6715090946797249,rot:0,feather:.35,amount:1,drift:.08},{id:"r5",shape:"rect",x:.5623629876981044,y:.782913275544842,w:.08559322919355261,h:.06566808181410566,rot:0,feather:.35,amount:1,drift:.08},{id:"r6",shape:"rect",x:.11829514514937525,y:.07327432690853983,w:.5237288677387684,h:.6580930349542624,rot:0,feather:.35,amount:1,drift:.08}]}],Cs=[],qs=["inside"],js={id:Ls,name:Is,scene:Us,mount:Ps,blend:Bs,opacity:Os,notes:Ns,lfos:zs,layers:Ds,dress:Cs,wears:qs},Gs="medium-trip",Xs="medium trip",Hs="room",Vs="plate",Ws="normal",Ys=1,Ks=`Background and other elements that need a medium-sized trip.
...
`,Js=[{id:"lfo-slow",name:"slow",shape:"sine",sync:!0,bars:32,hz:.25,phase:.2,duty:.5},{id:"lfo-drift",name:"drift",shape:"sine",sync:!0,bars:16,hz:.5,phase:.55,duty:.5}],Qs=[{id:"w1",effect:"wobble",on:!0,mix:1,params:{amount:{source:"music.low",base:9e-4,depth:.0045,curve:1.6,fall:.2},angle:{source:"lfo.slow",base:0,depth:1,curve:1,fall:.12},spin:0,sep:1}},{id:"w2",effect:"sway",on:!0,mix:1,params:{x:.02,y:.019,rate:.173,lag:.39}},{id:"breathe-1",effect:"breathe",on:!0,mix:1,params:{amount:.066,cx:.5,cy:.5,roll:0}},{id:"ripple-2",effect:"ripple",on:!0,mix:1,params:{amount:{source:"lfo.slow",base:.0304,depth:.0152,curve:1,fall:0},freq:41.1,speed:{source:"lfo.drift",base:.0856,depth:.0428,curve:1,fall:0},cx:.706,cy:.469}}],Zs=[],eo={id:Gs,name:Xs,scene:Hs,mount:Vs,blend:Ws,opacity:Ys,notes:Ks,lfos:Js,layers:Qs,dress:Zs};function _(e){return Number.isInteger(e)?String(e):String(Number(e.toFixed(4)))}function ee(e,t,o){if(!R(o))return null;const s=o,r=[];s.curve!==1&&r.push(`curve ${_(s.curve)}`),s.fall>0&&r.push(`fall ${_(s.fall)}s`);const n=`${_(s.base)} → ${_(s.base+s.depth)}`;return`| ${e} | ${t} | \`${s.source}\` | ${n} | ${r.join(", ")||"—"} |`}function ge(e,t){const o=Kt(e.scene),s=[];s.push(`# LOOK REQUEST — ${e.name}`),s.push(""),s.push(`\`${e.id}\` · ${t} · from the look studio (\`looks.html\`)`),s.push(""),e.notes.trim()!==""&&(s.push("> "+e.notes.trim().split(`
`).join(`
> `)),s.push("")),s.push("## Where it goes"),s.push(""),s.push(`- **built against** — ${o.name} (\`${o.id}\`)`);const r=e.wears??[];s.push(r.length===0?"- **wears in** — anywhere. It declares no scenes, so any host may mount it":`- **wears in** — ONLY ${r.map(a=>`\`${a}\``).join(", ")}. \`Look.tsx\` renders nothing elsewhere`),s.push(`- **mount** — ${e.mount==="plate"?"PLATE: the canvas replaces the flat background sheet, game props sit over it untouched":`OVER: the canvas sits above the board on \`mix-blend-mode: ${e.blend}\``}`),s.push(`- **opacity** — ${_(e.opacity)}`),s.push(`- **suggested host** — ${o.mountsAt}`),s.push(""),s.push("## The stack"),s.push(""),s.push("Bottom of this list is drawn first."),s.push("");for(const a of e.layers){const c=te(a.effect),p=c?.label??a.effect,v=a.on?"":" _(muted)_",u=R(a.mix)?`mix ← \`${a.mix.source}\``:M(a.mix)?`mix = \`${a.mix.expr}\``:`mix ${_(a.mix)}`;s.push(`- **${p}** — ${u}${v}`);const m=[];for(const f of c?.params??[]){const x=a.params[f.key];if(R(x)||M(x))continue;const E=typeof x=="number"?x:f.def;E!==f.def&&m.push(`${f.label} ${_(E)}`)}m.length>0&&s.push(`  - ${m.join(" · ")}`);for(const f of a.regions??[]){const x=R(f.amount)?`${_(f.amount.base)} → ${_(f.amount.base+f.amount.depth)} ← \`${f.amount.source}\``:M(f.amount)?`\`${f.amount.expr}\``:_(f.amount),E=f.rot===0?"":`, turned ${_(f.rot)}`;s.push(`  - ${f.shape==="ellipse"?"oval":"box"} at ${_(f.x)}, ${_(f.y)} · ${_(f.w*2)} × ${_(f.h*2)} of the frame${E} · edge ${_(f.feather)} · at ${x}`)}if((a.regions??[]).length>0){a.outside===!0&&s.push("  - **inverted** — the effect lands everywhere EXCEPT those");const f=a.spill??Se,x=a.lag??Re;s.push(f===0?"  - the rest of the screen gets **nothing** — a hard mask":`  - the rest of the screen gets **${_(f)}** of it, **${_(x)}s** behind`);const E=(a.regions??[]).map(w=>w.drift??ae);E.some(w=>w>0)&&s.push(`  - each region wanders off that by up to ${E.map(_).join(", ")} on its own noise`)}}e.layers.length===0&&s.push("_(empty)_"),s.push(""),s.push("## What moves"),s.push("");const n=[];for(const a of e.layers){const c=te(a.effect)?.label??a.effect,p=ee(c,"mix",a.mix);p!==null&&n.push(p);for(const[v,u]of Object.entries(a.params)){const m=ee(c,v,u);m!==null&&n.push(m)}for(const[v,u]of(a.regions??[]).entries()){const m=ee(c,`region ${v+1}`,u.amount);m!==null&&n.push(m)}}n.length===0?s.push("Nothing. Every parameter in this look is a fixed number."):(s.push("| layer | knob | driven by | range | shaping |"),s.push("| --- | --- | --- | --- | --- |"),s.push(...n)),s.push("");const l=(e.dress??[]).filter(a=>a.on);if(l.length>0){s.push("## The interface"),s.push(""),s.push("Driven by CSS, not by the shader — a canvas cannot see the cards. Written as the"),s.push("independent `translate`/`rotate`/`scale` properties, so the game keeps its own"),s.push("`transform` on every one of these. See `looks/dresser.ts`."),s.push("");for(const a of l){const c=_e(a.target),p=[];for(const v of se){const u=a.moves[v.key];u!==void 0&&(R(u)?p.push(`${v.label} ${_(u.base)} → ${_(u.base+u.depth)} ← \`${u.source}\``):M(u)?p.push(`${v.label} = \`${u.expr}\``):Math.abs(u-v.def)>1e-4&&p.push(`${v.label} ${_(u)}`))}s.push(`- **${c?.name??a.target}** (\`${c?.selector??"?"}\`)`),s.push(p.length>0?`  - ${p.join(" · ")}`:"  - _(nothing turned)_")}s.push("")}const h=e.lfos.filter(a=>de(e).includes(`lfo.${a.name}`));if(h.length>0){s.push("## The LFOs it uses"),s.push("");for(const a of h){const c=a.sync?`${_(a.bars)} bar${a.bars===1?"":"s"} — locked to the transport`:`${_(a.hz)} Hz — free running`,p=a.phase===0?"":`, phase ${_(a.phase)}`;s.push(`- \`lfo.${a.name}\` — ${a.shape}, ${c}${p}`)}s.push("")}const b=e.layers.filter(a=>a.on).length,g=e.layers.some(a=>a.on&&a.effect==="trails");s.push("## What it costs"),s.push(""),s.push(`- ${b} full-screen pass${b===1?"":"es"} per frame at 1180×720`),s.push(`- ${g?"holds a feedback buffer (one extra full-screen texture)":"no feedback buffer"}`);const d=e.layers.filter(a=>a.on&&(a.regions??[]).length>0).length;return d>0&&s.push(`- ${d} pass${d===1?"":"es"} masked to regions — cheaper than it looks, the mask short-circuits`),s.push(`- listens to: ${de(e).map(a=>`\`${a}\``).join(", ")||"nothing"}`),s.push(""),s.push("## To pick this up"),s.push(""),s.push("```"),s.push(`the look studio filed ${e.id} — wire it into the game`),s.push("```"),s.push(""),s.push(`The patch is next to this file at \`design/looks/${e.id}.look.json\`. It is`),s.push("the same format `src/breach/looks/render.ts` already reads, so wiring it in is"),s.push("mounting `<Look>` in the host above and pointing it at this id — not a port."),s.push(""),s.join(`
`)}const to=Object.assign({"../../../design/looks/cold-open.look.json":hs,"../../../design/looks/dusk-light.look.json":_s,"../../../design/looks/gentle-trip.look.json":Fs,"../../../design/looks/infiltrated.look.json":js,"../../../design/looks/medium-trip.look.json":eo}),xo=new Map(Object.entries(to).map(([e,t])=>{const o=e.split("/").pop()?.replace(".look.json","")??t.id;return[o,ke({...t,id:o},Ee)]})),so=()=>new Date().toISOString().replace(/\.\d+Z$/,"Z");async function _o(e,t){const o=so(),s=JSON.stringify({look:e,stamp:o,brief:t?ge(e,o):null});try{const r=await fetch("/__looks/save",{method:"POST",headers:{"content-type":"application/json"},body:s});return r.ok?{ok:!0,where:((await r.json()).files??[]).join("  ·  ")}:{ok:!1,where:`the dev server said ${r.status}`}}catch{return we(`${e.id}.look.json`,JSON.stringify(e,null,2),"application/json"),t&&we(`${e.id}.request.md`,ge(e,o),"text/markdown"),{ok:!1,where:"no dev server — downloaded instead"}}}function we(e,t,o){const s=URL.createObjectURL(new Blob([t],{type:o})),r=document.createElement("a");r.href=s,r.download=e,r.click(),setTimeout(()=>URL.revokeObjectURL(s),4e3)}const Le="breach.look.draft";function yo(e){try{localStorage.setItem(Le,JSON.stringify(e))}catch{}}function Eo(){try{const e=localStorage.getItem(Le);return e===null?null:ke(JSON.parse(e),Ee)}catch{return null}}export{bo as A,_o as B,uo as C,ae as D,wt as E,lo as F,co as G,po as H,Re as L,se as M,I as R,Se as S,Xe as T,ao as a,M as b,Rt as c,io as d,te as e,oe as f,ve as g,fo as h,R as i,Eo as j,wo as k,mo as l,xo as m,re as n,go as o,vo as p,no as q,ho as r,Kt as s,_e as t,yo as u,Yt as v,ro as w,ke as x,Ee as y,fe as z};
